...
def criar_card(icone, numero, texto, coluna_card):
    contanier = coluna_card.container(border=True)
    coluna_esquerda, coluna_direita = contanier.columns([1, 2.5])
...
criar_card('oportunidades.png',f'{base['Código Projeto'].count():,}' , 'Oportuinidades', coluna_esquerda)
